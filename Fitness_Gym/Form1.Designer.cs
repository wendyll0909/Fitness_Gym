namespace Fitness_Gym
{
    partial class LoginForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            loginPanel.Controls.Add(CreateAcc);
            ...
            ForgetAccLbl.Location = new Point(147, 234);
            ...
            // CreateAcc
            // 
            CreateAcc.BackColor = Color.FromArgb(44, 51, 70);
            CreateAcc.FlatStyle = FlatStyle.Flat;
            CreateAcc.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            CreateAcc.ForeColor = Color.White;
            CreateAcc.Location = new Point(47, 278);
            CreateAcc.Name = "CreateAcc";
            CreateAcc.Size = new Size(331, 52);
