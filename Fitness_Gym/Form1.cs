...
namespace Fitness_Gym
{
    public partial class LoginForm : Form
    {
        ...
        private void UserLogin()
        {
            ...
            try
            {
                using SqlConnection conn = new("Data Source=PC17\\SQLEXPRESS;Initial Catalog=PalenersGym;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
                conn.Open();
