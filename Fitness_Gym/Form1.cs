...
namespace Fitness_Gym
{
    public partial class LoginForm : Form
    {
        ...
        private void UserLogin()
        {
            ...
            try
            {
                using SqlConnection conn = new("Data Source=PC13\\SQLEXPRESS;Initial Catalog=PalenersGym;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
                conn.Open();
        ...
        private void CreateAcc_Click(object sender, EventArgs e)
        {
            ...
            if (registerForm.ShowDialog() == DialogResult.OK)
            {
                ...
                this.Show();
                usernameTb.Focus();
                passwordTb.Text = ""; // Clear password for security
            }
            else
            {
